  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <motion.button
        ...
        rounded-lg transition-all duration-200 border border-gray-800/50 hover:border-gray-700 cursor-pointer justify-between"
      >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-full left-0 mt-2 w-full min-w-[210px] bg-[#1e1e2e]/95 
