...
import { Snippet } from "./SnippetsClient";
...
type SnippetCardProps = {
  ...
  isStarred: boolean;
  onStarToggle: (snippetId: number, isCurrentlyStarred: boolean) => void;
            ...
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center gap-3">
                ...
                <div className="space-y-1 flex flex-col gap-0.5">
                  <span className="px-3 py-1 bg-blue-500/10 text-blue-400 rounded-lg text-xs font-medium capitalize">
                    {snippet.language}
                  </span>
              ...
              >
                <StarButton
                  ...
                  isStarred={isStarred}
                  starCount={snippet.starCount || 0}
                  onToggle={(snippetId) => onStarToggle(snippetId, isStarred)}
                />
