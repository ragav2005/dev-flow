...
export const LANGUAGE_CONFIG: LanguageConfig = {
  javascript: {
    ...
    pistonRuntime: { language: "javascript", version: "18.15.0" }, // language api
...
interface ThemeDefinition extends monacoNS.editor.IStandaloneThemeData {
  base: monacoNS.editor.BuiltinTheme;
}
